    ...
    sitemap: Ember.computed('i18n.locale', function () {
      ...
      return {
        nodes: [{
          ...
          link: null,
          icon: 'list',
          caption: i18n.t('forms.application.sitemap.git-hub-actions-test.caption'),
          title: i18n.t('forms.application.sitemap.git-hub-actions-test.title'),
          children: [{
            link: 'i-i-s-git-hub-actions-test-new-class1-l',
            caption: i18n.t('forms.application.sitemap.git-hub-actions-test.i-i-s-git-hub-actions-test-new-class1-l.caption'),
            title: i18n.t('forms.application.sitemap.git-hub-actions-test.i-i-s-git-hub-actions-test-new-class1-l.title'),
            children: null
          }]
        }]
      };
...
define('ember-app/controllers/i-i-s-git-hub-actions-test-new-class1-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    parentRoute: 'i-i-s-git-hub-actions-test-new-class1-l'
  });
});
define('ember-app/controllers/i-i-s-git-hub-actions-test-new-class1-e/new', ['exports', 'ember-app/controllers/i-i-s-git-hub-actions-test-new-class1-e'], function (exports, _iISGitHubActionsTestNewClass1E) {
  'use strict';
  ...
  var IISGitHubActionsTestNewClass1ENewController = _iISGitHubActionsTestNewClass1E.default;
  exports.default = IISGitHubActionsTestNewClass1ENewController;
});
define('ember-app/controllers/i-i-s-git-hub-actions-test-new-class1-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @type String
      @default 'i-i-s-git-hub-actions-test-new-class1-e'
     */
    editFormRoute: 'i-i-s-git-hub-actions-test-new-class1-e'
  });
});
...
define('ember-app/locales/en/forms/i-i-s-git-hub-actions-test-new-class1-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/forms/i-i-s-git-hub-actions-test-new-class1-l', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = {
    caption: 'IISGitHubActionsTestNewClass1L'
  };
});
define('ember-app/locales/en/models/i-i-s-git-hub-actions-test-new-class1', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-git-hub-actions-test-new-class1-l', 'ember-app/locales/en/forms/i-i-s-git-hub-actions-test-new-class1-e', 'ember-app/locales/en/models/i-i-s-git-hub-actions-test-new-class1'], function (exports, _translations, _iISGitHubActionsTestNewClass1L, _iISGitHubActionsTestNewClass1E, _iISGitHubActionsTestNewClass) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-git-hub-actions-test-new-class1': _iISGitHubActionsTestNewClass.default
    },
    ...
    forms: {
      ...
      'i-i-s-git-hub-actions-test-new-class1-l': _iISGitHubActionsTestNewClass1L.default,
      'i-i-s-git-hub-actions-test-new-class1-e': _iISGitHubActionsTestNewClass1E.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-git-hub-actions-test-new-class1-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-git-hub-actions-test-new-class1-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-git-hub-actions-test-new-class1', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-git-hub-actions-test-new-class1-l', 'ember-app/locales/ru/forms/i-i-s-git-hub-actions-test-new-class1-e', 'ember-app/locales/ru/models/i-i-s-git-hub-actions-test-new-class1'], function (exports, _translations, _iISGitHubActionsTestNewClass1L, _iISGitHubActionsTestNewClass1E, _iISGitHubActionsTestNewClass) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-git-hub-actions-test-new-class1', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  'use strict';
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('NewClass1E', 'i-i-s-git-hub-actions-test-new-class1', {
      a: (0, _attributes.attr)('A', { index: 0 })
    });
...
define('ember-app/mixins/regenerated/serializers/i-i-s-git-hub-actions-test-new-class1-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-git-hub-actions-test-new-class1', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-git-hub-actions-test-new-class1', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/i-i-s-git-hub-actions-test-new-class1'], function (exports, _emberCpValidations, _model, _offlineModel, _iISGitHubActionsTestNewClass) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISGitHubActionsTestNewClass.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_offlineModel.default, _iISGitHubActionsTestNewClass.Model, Validations, {});

  (0, _iISGitHubActionsTestNewClass.defineProjections)(Model);
...
define('ember-app/router', ['exports', 'ember-app/config/environment'], function (exports, _environment) {
  ...
  Router.map(function () {
    ...
    this.route('i-i-s-git-hub-actions-test-new-class1-e', { path: 'i-i-s-git-hub-actions-test-new-class1-e/:id' });
    this.route('i-i-s-git-hub-actions-test-new-class1-e.new', { path: 'i-i-s-git-hub-actions-test-new-class1-e/new' });
  });
...
define('ember-app/routes/i-i-s-git-hub-actions-test-new-class1-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    ...
    modelName: 'i-i-s-git-hub-actions-test-new-class1'
  });
});
define('ember-app/routes/i-i-s-git-hub-actions-test-new-class1-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'NewClass1E',
    modelName: 'i-i-s-git-hub-actions-test-new-class1',
    templateName: 'i-i-s-git-hub-actions-test-new-class1-e'
  });
});
define('ember-app/routes/i-i-s-git-hub-actions-test-new-class1-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    ...
    */
    ...
    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-git-hub-actions-test-new-class1'
    */
    modelName: 'i-i-s-git-hub-actions-test-new-class1',
    ...
    */
    developerUserSettings: Ember.computed(function () {
      return { IISGitHubActionsTestNewClass1L: {} };
    })
  });
});
...
define('ember-app/serializers/i-i-s-git-hub-actions-test-new-class1-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-git-hub-actions-test-new-class1-offline', 'ember-app/serializers/application-offline'], function (exports, _iISGitHubActionsTestNewClass1Offline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISGitHubActionsTestNewClass1Offline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-git-hub-actions-test-new-class1', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-git-hub-actions-test-new-class1', 'ember-app/serializers/application'], function (exports, _iISGitHubActionsTestNewClass, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISGitHubActionsTestNewClass.Serializer, {
    /**
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        'i-i-s-git-hub-actions-test-new-class1': 'id,a'
      });
...
define("ember-app/templates/i-i-s-git-hub-actions-test-new-class1-e", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "SJwMPKQs", "block": "{\"symbols\":[],\"statements\":[[6,\"h3\"],[10,\"class\",\"ui header\"],[8],[1,[26,\"t\",[\"forms.i-i-s-git-hub-actions-test-new-class1-e.caption\"],null],false],[9],[0,\"\\n\\n\"],[6,\"form\"],[10,\"class\",\"ui form flexberry-vertical-form\"],[10,\"role\",\"form\"],[8],[0,\"\\n  \"],[1,[26,\"flexberry-error\",null,[[\"error\"],[[22,[\"error\"]]]]],false],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[6,\"div\"],[10,\"class\",\"flexberry-edit-panel\"],[8],[0,\"\\n\"],[4,\"unless\",[[22,[\"readonly\"]]],null,{\"statements\":[[0,\"        \"],[6,\"button\"],[10,\"class\",\"ui button save-button\"],[3,\"action\",[[21,0,[]],\"save\"]],[8],[0,\"\\n          \"],[1,[26,\"t\",[\"forms.edit-form.save-button-text\"],null],false],[0,\"\\n        \"],[9],[0,\"\\n\"],[4,\"unless\",[[22,[\"model\",\"isNew\"]]],null,{\"statements\":[[0,\"          \"],[6,\"button\"],[10,\"class\",\"ui button save-del-button\"],[3,\"action\",[[21,0,[]],\"delete\"]],[8],[0,\"\\n            \"],[1,[26,\"t\",[\"forms.edit-form.delete-button-text\"],null],false],[0,\"\\n          \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"      \"],[6,\"button\"],[10,\"class\",\"ui button close-button\"],[3,\"action\",[[21,0,[]],\"close\"]],[8],[0,\"\\n        \"],[1,[26,\"t\",[\"forms.edit-form.close-button-text\"],null],false],[0,\"\\n      \"],[9],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field flexberry-validationsummary-container\"],[8],[0,\"\\n    \"],[6,\"div\"],[10,\"class\",\"sixteen wide\"],[8],[0,\"\\n      \"],[1,[26,\"flexberry-validationsummary\",null,[[\"errors\"],[[26,\"get\",[[22,[\"validationObject\",\"validations\"]],\"messages\"],null]]]],false],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[1,[26,\"flexberry-field\",null,[[\"readonly\",\"value\",\"class\",\"label\",\"data-test-i-i-s-git-hub-actions-test-new-class1-e-a\"],[[22,[\"readonly\"]],[22,[\"model\",\"a\"]],[26,\"if\",[[26,\"get\",[[26,\"get\",[[22,[\"validationObject\",\"validations\",\"attrs\"]],\"a\"],null],\"isInvalid\"],null],\"error\"],null],[26,\"t\",[\"forms.i-i-s-git-hub-actions-test-new-class1-e.a-caption\"],null],true]]],false],[0,\"\\n    \"],[1,[26,\"flexberry-validationmessage\",null,[[\"error\"],[[26,\"get\",[[26,\"get\",[[22,[\"validationObject\",\"validations\",\"attrs\"]],\"a\"],null],\"message\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n\"],[9]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/i-i-s-git-hub-actions-test-new-class1-e.hbs" } });
});
define("ember-app/templates/i-i-s-git-hub-actions-test-new-class1-l", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "f9loD9Ke", "block": "{\"symbols\":[],\"statements\":[[1,[26,\"flexberry-error\",null,[[\"error\"],[[22,[\"error\"]]]]],false],[0,\"\\n\"],[6,\"h3\"],[8],[1,[26,\"t\",[\"forms.i-i-s-git-hub-actions-test-new-class1-l.caption\"],null],false],[9],[0,\"\\n\"],[6,\"div\"],[10,\"class\",\"row\"],[8],[0,\"\\n  \"],[1,[26,\"flexberry-objectlistview\",null,[[\"modelName\",\"modelProjection\",\"editFormRoute\",\"content\",\"createNewButton\",\"refreshButton\",\"sorting\",\"orderable\",\"sortByColumn\",\"addColumnToSorting\",\"beforeDeleteAllRecords\",\"pages\",\"perPageValue\",\"perPageValues\",\"recordsTotalCount\",\"hasPreviousPage\",\"hasNextPage\",\"previousPage\",\"gotoPage\",\"nextPage\",\"componentName\",\"data-test-olv\"],[[22,[\"modelName\"]],[22,[\"modelProjection\"]],[22,[\"editFormRoute\"]],[22,[\"model\"]],true,true,[22,[\"computedSorting\"]],true,[26,\"action\",[[21,0,[]],\"sortByColumn\"],null],[26,\"action\",[[21,0,[]],\"addColumnToSorting\"],null],[26,\"action\",[[21,0,[]],\"beforeDeleteAllRecords\"],null],[22,[\"pages\"]],[22,[\"perPageValue\"]],[22,[\"perPageValues\"]],[22,[\"recordsTotalCount\"]],[22,[\"hasPreviousPage\"]],[22,[\"hasNextPage\"]],[26,\"action\",[[21,0,[]],\"previousPage\"],null],[26,\"action\",[[21,0,[]],\"gotoPage\"],null],[26,\"action\",[[21,0,[]],\"nextPage\"],null],\"IISGitHubActionsTestNewClass1L\",true]]],false],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/i-i-s-git-hub-actions-test-new-class1-l.hbs" } });
});
define("ember-app/templates/i-i-s-git-hub-actions-test-new-class1-l/loading", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "K29ac7es", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[10,\"class\",\"loading-pane\"],[8],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"loading-message\"],[8],[0,\"\\n    Loading ...\\n    \"],[6,\"div\"],[10,\"class\",\"spinner\"],[8],[9],[0,\"\\n  \"],[9],[0,\"\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/i-i-s-git-hub-actions-test-new-class1-l/loading.hbs" } });
});
